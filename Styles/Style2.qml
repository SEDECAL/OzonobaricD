...
pragma Singleton    // Azure Bug 10900: (SDV 2) Progress indicator color review
import QtQuick 2.0
...
//      readonly property color backColor: "#121212"
    ...
    property QtObject param: QtObject {
        property QtObject edition: QtObject {
            property QtObject unitsColor: QtObject {
                 ...
                 readonly property color c_bag_volume:    "forestgreen"//"darkorchid"
                 readonly property color waiting_time:    "darkgoldenrod"
                 readonly property color i_rectal_volume: "forestgreen"//"darkorchid"
                 readonly property color dose:            "deepskyblue"//"saddlebrown"
            ...
            property QtObject mainColor: QtObject {
                 ...
                 readonly property color c_bag_volume:    "limegreen"//"orchid"
                 readonly property color waiting_time:    "gold"
                 readonly property color i_rectal_volume: "limegreen"//"orchid"
                 readonly property color dose:            "lightskyblue"//"sandybrown"
    ...
    property QtObject input: QtObject {
        ...
        readonly property int   shadowRadius: 10
        readonly property color backColor:   "#424242"  // white & 0.2 opacity
    ...
    property QtObject configurationArea: QtObject {
        readonly property color backColor:   "#2A2A2A"
        readonly property color cardColor:   "#424242"
        ...
        readonly property color tabViewDisabledColor: "#222222"
    }
